...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        perfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent user = new Intent(MapsActivity.this, Perfil.class);
                startActivity(user);
            }
        });
        ...
        contactos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent conta = new Intent(MapsActivity.this, Contactos.class);
                startActivity(conta);
            }
        });
        ...
        myLugar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent place = new Intent(MapsActivity.this, Mis_Lugares.class);
                startActivity(place);
            }
        });
        ...
        agente.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent agen = new Intent(MapsActivity.this, Agente_Policiaco.class);
                startActivity(agen);
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(20.6736, -103.344);
